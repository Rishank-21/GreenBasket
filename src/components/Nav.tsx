    ...
    ? createPortal(
        <AnimatePresence>
          <motion.div
            ...
            className="fixed top-0 left-0 h-full w-[75%] sm:w-[60%] z-99999 bg-linear-to-b from-green-800/90 via-green-700/80 to-green-900/90 backdrop-blur-xl border-r border-green-400/20 shadow-[0_0_50px_-10px_rgba(0,255,100,0.3)] flex flex-col p-6 text-white"
          >
      ...
      <div className="flex items-center gap-3 md:gap-6 relative">
        {user.role === "user" && (
          <>
            ...
            text-xs w-5 h-5 flex items-center justify-center rounded-full font-semibold shadow"
              >
                {cartData.length}
              </span>
            </Link>
