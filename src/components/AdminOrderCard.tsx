...
const AdminOrderCard = ({ order }: { order: IOrder }) => {
     ...
     const updateStatus = async (orderId:string|undefined, status:string) => {
      try {
    ...
    >
      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
        ...
        <div className="flex flex-col items-start md:items-end gap-2">
          ...
          {status !== "delivered" &&  <select className="border border-gray-300 rounded-lg px-3 py-1 text-sm shadow-sm hover:border-green-400 transition focus:ring-2 focus:ring-green-600 outline-none"       
